  ...
  flex-col`}>
    ...
    w-full`}>
      <div className="flex flex-col flex-1 justify-start mr-10">
        <img src={logo} alt="hoobank" className="w-[260px] h-[72px]
        object-contain"/>
          ...
          my-4 min-w-[150px]'>
            ...
            <ul className="list-none mt-4">
              {footerLink.links.map((link, index) => (
                ...
                cursor-ponter ${index !== footerLink.links.length - 1 
                ? 'mb-4' : 'mb-0'}`}>
                  {link.name}
                </li>
              ))}
    ...
    flex-col pt-6 border-t border-t-[#3f3r45]">
      ...
      <div className="flex flex-row md:mt-0 mt-6">
        {socialMedia.map((socMed, index) => (
          <img key={socMed.id} src={socMed.icon} alt={socMed.icon} 
